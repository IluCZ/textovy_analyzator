...
author: Richard Cibere
email: richard.cibere@seznam.cz
discord: Richard C.#4442
"""
import re
...
# `dict.get()` vrati None kdyz, nenajde key
if uzivatel == None:
    print("uzivatel", jmeno, "neregistrován, ukončuji program")
    quit()

# uzivatel existuje v dict `registrovany_uzivatele`
# ted dava smysl zeptat se na heslo, a to potom porovnat
